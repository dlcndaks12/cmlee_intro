...
(function($) {
    ...
    CircleProgress.prototype = {
         ...
         */
        initFill: function() {
            var self = this, fill = this.fill, ctx = this.ctx, size = this.size;
         ...
         */
        drawArc: function(v) {
            var ctx = this.ctx, r = this.radius, t = this.getThickness(), a = this.startAngle;
            ctx.save();
            ctx.beginPath();
            if (!this.reverse) {
        ...
        drawAnimated: function(v) {
            var self = this, el = this.el, canvas = $(this.canvas);
    ...
    $.fn.circleProgress = function(configOrCommand, commandArgument) {
        var dataName = "circle-progress", firstInstance = this.data(dataName);
